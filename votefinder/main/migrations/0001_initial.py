    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_tick', models.CharField(default='https://{}/t.png'.format(settings.VF_PRIMARY_DOMAIN), max_length=256)),
                ('empty_tick', models.CharField(default='https://{}/te.png'.format(settings.VF_PRIMARY_DOMAIN), max_length=256)),
